...
graph TD;
    ...
    E --> H["<b>03 Treatment response (MASTERMIND) cohort</b>: <br> n=995,036 with 3,218,100 unique drug periods <br> For T2D 1st instance dataset excluding drug starts within 91 days of registration n=769,394 with 1,663,398 unique drug periods <br> With script for diabetes medication <br> Index date=drug start date"]
```
