...
|**template_comorbidities**: finds onset of comorbidities relative to cohort index dates | **{cohort_prefix}\_comorbidities**:  1 row per patid-index date combination, with earliest pre-index date occurrence, latest pre-index date occurrence, and earliest post-index date occurrence |
