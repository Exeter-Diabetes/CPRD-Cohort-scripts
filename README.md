...
| current_oha | whether prescription for insulin within last 6 months of data | last 6 months of data = those before gp_end_date |
...
| secondary_death_cause1-17 | secondary death cases from ONS data (ICD10; 'cause'1-17' in cleaned ONS death table - can be >15 because raw table had multiple rows per patient with same death date) | Raw ONS death data processed as per: https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main?tab=readme-ov-file#ons-death-data-from-cprd-2024-update | 
| cv_death_primary_cause | 1 if primary cause of death is CV | Raw ONS death data processed as per: https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main?tab=readme-ov-file#ons-death-data-from-cprd-2024-update | 
| cv_death_any_cause | 1 if any (primary or secondary) cause of death is CV | Raw ONS death data processed as per: https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main?tab=readme-ov-file#ons-death-data-from-cprd-2024-update | 
| hf_death_primary_cause | 1 if primary cause of death is heart failure | Raw ONS death data processed as per: https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main?tab=readme-ov-file#ons-death-data-from-cprd-2024-update | 
| hf_death_any_cause | 1 if any (primary or secondary) cause of death is heart failure | Raw ONS death data processed as per: https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main?tab=readme-ov-file#ons-death-data-from-cprd-2024-update | 
| kf_death_primary_cause | 1 if primary cause of death is kidney failure | Raw ONS death data processed as per: https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main?tab=readme-ov-file#ons-death-data-from-cprd-2024-update | 
| kf_death_any_cause | 1 if any (primary or secondary) cause of death is kidney failure | Raw ONS death data processed as per: https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main?tab=readme-ov-file#ons-death-data-from-cprd-2024-update | 
