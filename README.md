...
|**template_final_merge**: pulls together variables from all of the above tables and additionally calculates 10-year QRISK2 score at index dates | **{cohort_prefix}\_final_merge**: 1 row per patid-index date combination with relevant biomarker/comorbidity/smoking/alcohol variables |
