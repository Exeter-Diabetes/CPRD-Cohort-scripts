...
ncurrtx | number of major drug classes (DPP4, GIPGLP1, GLP1, INS, MFN, SGLT2, SU, TZD) patient is currently taking, not including current treatment | Missing where substance_start_only==1 |
