...
## Adherence
adherence <- adherence %>% analysis$cached("adherence")
...
## Merge in glycaemic failure, discontinuation and adherence - both are currently by drug class (not substance) only
...
all_diabetes_1stinstance <- all_diabetes_1stinstance %>%
  ...
  left_join(adherence, by = c("patid", "dstartdate" = "dstartdate_class", "drug_class")) %>%
