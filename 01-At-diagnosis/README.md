...
|**at_diag_composite_comorbidities**: creates composite microvascular complication definitions (non severe and severe retinopathy, neuropathy and nephropathy) | **at_diag_composite_comorbidities**:  1 row per patid (as there are no patids with >1 index date) with earliest pre-index date code occurrence, latest pre-index date code occurrence, and earliest post-index date code occurrence of microvascular complications |
...
Death causes included: cardiovascular (CV) death, heart failure, kidney failure, stroke, myocardial infarction, hyperglycaemia, hypoglycaemia, peripheral vascular disease, sudden death, hematological cancer, solid cancer, any cancer and pancreatic cancer, all as the primary cause or any cause.
