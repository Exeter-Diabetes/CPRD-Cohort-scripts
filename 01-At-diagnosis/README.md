...
Comorbidities included: atrial fibrillation, angina (overall and specifically unstable angina recorded in hospital), anxiety, asthma, benign prostate hyperplasia, blindness and visual impairment, bronchiectasis, charcot foot, CKD stage 5/ESRD, CLD, COPD, cystic fibrosis, dementia, DKA (hospital data only), falls, family history of diabetes, family history of premature cardiovascular disease, foot ulcer infection/ischaemia, mild/moderate/severe frailty, gastroparesis, haematological cancers, heart failure, hypertension (uses primary care data only, see note in script), IHD, lower limb amputation, lower limb fracture, major and minor amputations in hospital (doesn't only include primary cause), myocardial infarction (overall and more specifically in hospital with a reduced codelists: “incident_mi”), neuropathic pain, non-severe neuropathy, non-severe retinopathy, osteoporosis, osmotic symptoms (micturition control, volume depletion, urinary frequency), PAD, painful peripheral neuropathy, photocoagulation therapy (hospital data only), proliferative retinopathy (contains photocoagulation), pulmonary fibrosis, pulmonary hypertension, revascularisation (coronary artery), rheumatoid arthritis, solid cancer, solid organ transplant, stroke (overall and more specifically in hospital with a reduced codelists: “incident_stroke”), TIA, vitreous and pre-retinal disease, vitreous haemorrhage (hospital data only), “primary_hhf” (hospitalisation for HF with HF as primary cause), “primary_incident_mi” (hospitalisation for MI with MI as primary cause using incident_mi codelist), and “primary_incident_stroke” (hospitalisation for stroke with stroke as primary cause using incident_stroke codelist). 
